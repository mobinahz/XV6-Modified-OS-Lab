...
extern int sys_init_sharedmem(void);
extern int sys_acquire_priority(void);
extern int sys_release_priority(void);
...
[SYS_init_sharedmem]  sys_init_sharedmem,
[SYS_acquire_priority] sys_acquire_priority,
[SYS_release_priority] sys_release_priority,
};
