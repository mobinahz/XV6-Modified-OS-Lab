...
// fetch float from address in current process
int
...
// argfloat for fetching float form structs
int      
...
extern int sys_set_bjf_params_sys(void);
...
[SYS_set_bjf_params_sys] sys_set_bjf_params_sys,
};
